...
public class InputUpdateProduct(string? name, string? description, decimal price, long stock, long categoryId, string? imageURL) : BaseInputUpdate<InputUpdateProduct>
{
